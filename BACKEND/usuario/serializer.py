...
class ClienteSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        validated_data['idRol'] = Rol.objects.get(idRol=1)  # Asignar el rol de Cliente automáticamente
...
class AgenteSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        validated_data['idRol'] = Rol.objects.get(idRol=2)  # Asignar el rol de Agente automáticamente
